    ...
    return (
        <Box pt="100px" textAlign="center">
            <Box
                ...
                h='800px'
            >
                <Heading pt={10} fontSize='35px' display={{ base: 'none', md: 'block' }}>チームを作って、トレーニングスケジュールを管理しよう。</Heading>
                <Heading px={2} pt={10} fontSize='25px' display={{ base: 'block', md: 'none' }}>チームを作って<br/>トレーニングスケジュールを<br/>管理しよう。</Heading>
                <Stack mt='50px'>
                    <PrimaryLargeButton
                        name='login-modal'
                ...
                <Text mt='100px' fontSize='20px' mb={2}>お試しの使用はこちら</Text>
                <Button
                    borderRadius="1000px"
