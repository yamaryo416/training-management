            ...
            <Box pb={10}>
                <Stack spacing={5}>
                    ...
                    <Flex alignItems="center">
                        ...
                        <Text pl={4} data-testid='team-coach-name'>{coachName}</Text>
                    </Flex>
                    <Flex alignItems="cneter">
                        <Heading fontSize={{ base: "13px", md: "16px" }}>チーム人数:</Heading>
                        <Text pl={4} data-testid='team-join-count'>{joinCount}人</Text>
                    </Flex>
