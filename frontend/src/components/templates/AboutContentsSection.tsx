  ...
  return (
    <Box textAlign="center" color="white" pt="100px">
      ...
      <Box fontSize={{ base: '18px', md: '20px' }} mt={5}>
        ...
        <Center my={10}>
          <Image src="/images/about-image1.png" />
        </Center>
        <Text display={{ base: 'none', md: 'block' }}>
          また、スケジュールを実施した際に、『実施する』ボタンを押すことで、記録を残すことができます。
        </Text>
        <Text display={{ base: 'block', md: 'none' }}>
          また、スケジュールを実施した際に、
          <br />
        ...
        <Center my={10}>
          <Image src="/images/about-image2.png" />
        </Center>
        <Text display={{ base: 'none', md: 'block' }}>
          スケジュールごとに実施したメンバーを確認できます。
        </Text>
        <Text display={{ base: 'block', md: 'none' }}>
          スケジュールごとに
          <br />
