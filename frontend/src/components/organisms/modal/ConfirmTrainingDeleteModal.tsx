...
export const ConfirmTrainingDeleteModal: VFC = memo(() => {
    ...
    const confirmTrainingDeleteModal = useRecoilValue(confirmTrainingDeleteModalState)
        ...
        >
            ...
            {description !== "" && (
                <Flex>
                    ...
                    <Text pl={2} fontSize='16px' data-testid='delete-training-description'>{description}</Text>
                </Flex>
            )} 
