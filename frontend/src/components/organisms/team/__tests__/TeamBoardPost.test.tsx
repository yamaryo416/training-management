...
describe('TeamBoardPostItem', () => {
    ...
    it('Should render correct contents', async () => {
        ...
        expect(screen.queryByTestId('1-post-created-at')).toHaveTextContent(moment().add(-1, 'days').format("M月D日 H時m分"))
        expect(screen.queryAllByTestId('other-post').length).toEqual(5)
        expect(screen.queryByText('post6')).toBeInTheDocument()
        expect(screen.queryByTestId('6-post-created-at')).toHaveTextContent(moment().add(-6, 'days').format("M月D日 H時m分"))
